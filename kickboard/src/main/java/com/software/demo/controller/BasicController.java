...
public class BasicController {
    ...
    public KickboardDto kickboardFee(@RequestParam String distanceStr) {
        ...
        KickboardTime kickboardTime = kickboardService.changeToEstimatedTime(distance);
        KickboardDto kickboardDto = kickboardService.getAllFee(kickboardTime.getEstimatedTime());

        System.out.println("kickboardTime = " + kickboardTime);
        System.out.println("kickboardTime = " + kickboardDto);
